let gameState = 'start'; 
let paddle_1 = document.querySelector('.plate_1'); 
let paddle_2 = document.querySelector('.plate_2'); 
let board = document.querySelector('.board'); 
let initial_ball = document.querySelector('.ball'); 
let ball = document.querySelector('.ball'); 
let score_1 = document.querySelector('.player_score'); 
...
let paddle_common = document.querySelector('.plate').getBoundingClientRect(); 
